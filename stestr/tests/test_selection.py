...
class TestConstructList(base.TestCase):
    def test_simple_re(self):
        test_lists = [
            "fake_test(scen)[tag,bar])",
            "fake_test(scen)[egg,foo])",
            "fake_test(necs)[tag,bar])",
            "fake_test(necs)[egg,foo])",
            "fake_test(nnnn)[foo,bar])",
            "fake_test(nnnn)[foo,foo])",
        ]
    ...
    def test_simple_re_randomized(self):
        ...
        result = selection.construct_list(test_lists, regexes=["foo"], randomize=True)
